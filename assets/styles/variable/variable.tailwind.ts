...
export default {
  colors: {
    ...
    "primary-80": styleVariables.color["primary-80"],
    "leis-primary-1": styleVariables.color["leis-primary-1"],
    "leis-primary-2": styleVariables.color["leis-primary-2"],
    "leis-secondary-yellow": styleVariables.color["leis-secondary-yellow"],
    "leis-secondary-green": styleVariables.color["leis-secondary-green"],
